...
export class ApiError extends Error {
  ...
  /** Member's gym membership (subscription) has lapsed — block check-in until renewed. */
  static membershipExpired(
    message = 'Your membership has expired. Please renew your membership plan.',
    details?: unknown,
  ): ApiError {
    return new ApiError(403, 'MEMBERSHIP_EXPIRED', message, details);
  }
